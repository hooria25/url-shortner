...
class Form extends React.Component{
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "UrlShortner.com/" + generatedKey

        if(this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "UrlShortner.com/" + this.state.preferedAlias
        }
        ...
        validateInput = async () => {
            ...
            if(this.state.preferedAlias !== ''){
                if(this.state.preferedAlias.length > 8){
                    ...
                    errorMessages['suggestedAlias'] = 'Please enter an Alias less than 8 characters';
                ...
                if (keyExists.exists()){
                    errors.push("suggestedAlias");
                    errorMessages['suggestedAlias'] = 'The Alias you have entered already exists! Please enter a different one';
                }
            }
            ...
            return(
                <div className="container">
                    <form autoComplete="off">
                        ...
                        <div
                            className={
                                this.hasError("longURL") ? "test-danger" : "visiually-hidden"
                            }
                        >
                        ...
                        <div className="form-group">
                            <label htmlFor="basicl-url">Your shortened URL</label>
                            <div className="input-group mb-3">
                                <div className="input-group=prepend">
                                    <span className="input-group-text">UrlShortner.com/</span>
                                </div>
                                <input
                                    id = "preferedAlias"
                                    onChange = {this.handleChange}
                                    ...
                                    type="text" placeholder="eg. xyq6dg8 (Optional)"
                                />
                            </div>
                            <div
                            className={
                    ...
                    </button>
                    {
                        ...
                        <div className="generatedurl">
                            ...
                            <div className="input-group-mb3">
                                <input disabled typed="text" value={this.state.generatedURL} className="forms-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2" />
